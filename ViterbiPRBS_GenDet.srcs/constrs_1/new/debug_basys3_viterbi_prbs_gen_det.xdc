...
# Switches
#switch 0
set_property PACKAGE_PIN V17 [get_ports {gen_data}]					
...
#switch 8
set_property PACKAGE_PIN V2 [get_ports {num_errors[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {num_errors[0]}]
#switch 9
set_property PACKAGE_PIN T3 [get_ports {num_errors[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {num_errors[1]}]
#switch 10
set_property PACKAGE_PIN T2 [get_ports {num_errors[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {num_errors[2]}]
#switch 11
set_property PACKAGE_PIN R3 [get_ports {num_errors[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {num_errors[3]}]
#switch 12
set_property PACKAGE_PIN W2 [get_ports {num_errors[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {num_errors[4]}]
#switch 13
set_property PACKAGE_PIN U1 [get_ports {num_errors[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {num_errors[5]}]
#switch 14
set_property PACKAGE_PIN T1 [get_ports {num_errors[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {num_errors[6]}]
#Switch 15 
set_property PACKAGE_PIN R2 [get_ports {num_errors[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {num_errors[7]}]
 

# LEDs

#LD0
set_property PACKAGE_PIN U16 [get_ports {encoder_err}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {encoder_err}]
...
#BtnR
set_property PACKAGE_PIN T17 [get_ports gen_err_2bit]						
	set_property IOSTANDARD LVCMOS33 [get_ports gen_err_2bit]
#BtnD
set_property PACKAGE_PIN U17 [get_ports gen_err_3bit]						
	set_property IOSTANDARD LVCMOS33 [get_ports gen_err_3bit]
...
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {decoded_word0}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_word0}]
##Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {decoded_word1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {decoded_word1}]
##Sch name = JA3
...
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {enc_dec_ready}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {enc_dec_ready}]
##Sch name = JB10 
#set_property PACKAGE_PIN C16 [get_ports {clk_out}]					
...
##Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {dec_rdy}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dec_rdy}]
##Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {enc_rdy}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {enc_rdy}]
##Sch name = JC7
...
##Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {prbsgen_dec_ready}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {prbsgen_dec_ready}]
##Sch name = JC10
set_property PACKAGE_PIN R18 [get_ports {prbs_val_data}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {prbs_val_data}]
